Este é um projeto [Next.js](https://nextjs.org/) projeto com bootstrapped [`create-next-app`](https://github.com/vercel/next.js/tree/canary/packages/create-next-app).
